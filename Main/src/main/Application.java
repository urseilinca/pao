...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        citesteAngajat(service,cabmed,notserv,"C:/Users/abarb/Downloads/Main/angajati.csv");
        citesteClient(service,cabmed,notserv,"C:/Users/abarb/Downloads/Main/clienti.csv");
        citesteClientMinor(service,cabmed,notserv,"C:/Users/abarb/Downloads/Main/clientiminori.csv");
        citesteProgrORL(service,cabmed,notserv,"C:/Users/abarb/Downloads/Main/programareORL.csv");

        while(true) {
            System.out.println("Please type one of the following commands: add, view, update, delete or exit");
            ...
            switch(line) {
                ...
                case "view" : {
                    ...
                    switch(viewtype) {
                        case "clients": {
                          System.out.println("Please specify the client id:");
                          int clientid = Integer.parseInt(scanner.nextLine());
                          Optional<Client> Client =
                            service.getClientById(cabmed,clientid);
                    if(Client.isPresent()) {
                        ...
                        case "doctors": { 
                          ...
                          int clientid = Integer.parseInt(scanner.nextLine());
                          Optional<Angajat> Angajat =
                            service.getAngajatById(cabmed,clientid);
                ...
                case "exit" :
                    ...
                    break;
                case "delete":{
                    System.out.println("Please specify whether you want to delete the clients, the doctors or the appointments:");
                    String viewtype = scanner.nextLine();
                    switch(viewtype) {
                        case "clients": {
                          System.out.println("Please specify the client id:");
                          int clientid = Integer.parseInt(scanner.nextLine());
                          service.deleteClientById(cabmed,clientid);
                          notserv.send("delete");
                          break;  
                        }
                        case "doctors": {
                           System.out.println("Please specify the employee id:");
                          int clientid = Integer.parseInt(scanner.nextLine());
                          service.deleteAngajatById(cabmed,clientid);
                          notserv.send("delete");
                          break;   
                        }
                        case "appointments": {
                          ...
                          System.out.println("Please specify the appointment type: orl/oft/dermato");
                            ...
                            switch(appointmenttype) {
                                case "orl": {
                                   System.out.println("Please specify the appt id:");
                          int clientid = Integer.parseInt(scanner.nextLine());
                          service.deleteProgr(cabmed,clientid);
                          notserv.send("delete");
                          break;  
                                }
                                case "oft": {
                ...
                case "update":{
                    ...
                    switch(updateType) {
                        case "client" : {
                            ...
                            switch(clientType){
                                case "minor": {
                                    System.out.println("Please specify the client's id");
                                    int id=Integer.parseInt(scanner.nextLine());
                                    System.out.println("Please specify the client's details: name/cnp/varsta/email/phone number/cnpadult");
                                    service.updateClient(cabmed, id,buildClientMinor(scanner.nextLine()));
                                    notserv.send("add");
                                    break;
                                }
                                case "not a minor": {
                                    ...
                                    int id=Integer.parseInt(scanner.nextLine());
                                    System.out.println("Please specify the client's details: name/cnp/varsta/email/phone number");
                                    service.updateClient(cabmed, id,buildClient(scanner.nextLine()));
                                    notserv.send("add");
                                    break;
                                }
                                default: System.out.println("This client type doesn't exist.");
                        ...
                        case "doctor" : {
                            System.out.println("Please specify the employee's id");
                            int id=Integer.parseInt(scanner.nextLine());
                            System.out.println("Please specify the employee's details: name/cnp/varsta/email/phone number");
                            service.updateAngajat(cabmed, id,buildAngajat(scanner.nextLine()));
                            notserv.send("add");
                            break;
                        }
                        default:System.out.println("This type doesn't exist.");
